        ...
        <div class="row">
              ...
              <div class="modal-dialog modal-cart">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <button type="button" class="btn fs-3" data-bs-dismiss="modal" aria-label="Close"><i class="bi bi-bag-dash"></i></button>
                  </div>
                  <div class="modal-body">
                    ...
                    <hr>                    
                    <div class="row">
                      <p class="fs-3">Sub Total <span class="fs-2 float-end fw-bolder" id="subtotal">Rs.1200</span></p>
                    </div>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary fs-5"><i class="bi bi-bag-plus-fill"></i> Add To Bag</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              ...
              <h4>Cheese Stick</h4>
              <p>description</p>
              <span>Rs.430 <button   onClick="addToBag(this)"  class="btn btn-warning float-end"><i class="bi bi-bag-plus-fill"></i> Add To Bag</button></span>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0">
            <div class="box">
              ...
              <h4>Cheese Stick</h4>
              <p>description</p>
              <span>Rs.350 <button class="btn btn-warning float-end"><i class="bi bi-bag-plus-fill"></i> Add To Bag</button></span>
            </div>
          </div>
